...
// ReserveFirstFreeAddressAnon marks the first free IP address in a subnet as "used", and returns it as a string.
func (c *Controller) ReserveFirstFreeAddressAnon(id int) (out string, err error) {
